...
class EnglantiSaa extends Component {
  constructor(props) {
    super(props);
    this.state = {
      paikkakunta: '',
  ...
  componentDidMount = () => {
    return fetch(
      'http://api.openweathermap.org/data/2.5/weather?q=London&APPID=32f1264bba3945837fa37cc1c29b4db1'
    )
